 ...
 * Noite Feliz
 * 
 * Código para tocar a música Noite Feliz com um Buzzer. 
 * 
 * Evans Picolo
 * Asthor Barden
 * ago/2021
...
void setup()
{
    ...
    G4(2); a4(8); G4(4); E4(1); pausa(4); 
    
    G4(2); a4(8); G4(4); E4(1); pausa(4);

    D5(2); D5(4); B4(2); B4(4); C5(2); C5(4); G4(1); pausa(4);

    a4(2); a4(4); C5(2); B4(8); a4(4); G4(2); a4(8); G4(4); E4(1); pausa(4);

    D5(2); D5(4); F5(2); D5(8); B4(4); C5(2); E5(1); pausa(4);

    C5(2); G4(8); E4(4); G4(2); F4(8); D4(4); C4(2);
